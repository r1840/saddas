  ...
  return (
    <div classNazwa="min-h-screen bg-background">
      ...
      <main classNazwa="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 classNazwa="text-4xl font-bold mb-2">Terms of Service</h1>
        ...
        <div classNazwa="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">2. Description of Service</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">3. User Accounts</h2>
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">4. Trading Platform</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">5. Market Data</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">6. Prohibited Activities</h2>
            <p classNazwa="leading-relaxed text-muted-foreground mb-3">
              You agree not to:
            </p>
            <ul classNazwa="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">7. Intellectual Property</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">8. Disclaimer of Warranties</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">9. Limitation of Liability</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">10. Changes to Terms</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">11. Contact Information</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
