  ...
  return (
    <div classNazwa="min-h-screen bg-background">
      <header classNazwa="border-b border-border bg-card">
        <div classNazwa="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link href="/">
            <Button variant="ghost" classNazwa="gap-2">
      ...
      <main classNazwa="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 classNazwa="text-4xl font-bold mb-2">Privacy Policy</h1>
        <p classNazwa="text-muted-foreground mb-8">Last updated: January 24, 2026</p>

        <div classNazwa="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">1. Introduction</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">2. Information We Collect</h2>
            <p classNazwa="leading-relaxed text-muted-foreground mb-3">
              We collect the following types of information:
            </p>
            <ul classNazwa="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">3. How We Use Your Information</h2>
            <p classNazwa="leading-relaxed text-muted-foreground mb-3">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">4. Data Storage and Security</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">5. Third-Party Services</h2>
            <p classNazwa="leading-relaxed text-muted-foreground mb-3">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">6. Cookies and Tracking</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">7. Data Sharing</h2>
            <p classNazwa="leading-relaxed text-muted-foreground mb-3">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">8. Your Rights</h2>
            <p classNazwa="leading-relaxed text-muted-foreground mb-3">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">9. Data Retention</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">10. Children's Privacy</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">11. International Data Transfers</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">12. Changes to Privacy Policy</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 classNazwa="text-2xl font-semibold mb-4">13. Contact Us</h2>
            <p classNazwa="leading-relaxed text-muted-foreground">
